...
void portdriver_init (struct portdriver_struct *port, uint8_t directionmask, volatile uint8_t * directionptr, volatile uint8_t *input_ptr, volatile uint8_t *outputptr){
